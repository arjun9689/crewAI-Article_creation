...
planner = Agent(
    ...
    backstory="You are working on planning a blog article about the topic: {topic}. You collect information that helps the audience learn something and make informed decisions."
...
writer = Agent(
    ...
    "You base your writing on the work of the Content Planner, who provides an outline and relevent context about the topic."
...
editor = Agent(
    ...
    backstory="You are an editor who receives a blog posst from the Content Writer."
...
plan = Task(
    description=(
        ...
        "2. Identify the target audience, consider their interests and pain points.\n"
...
result=crew.kickoff({"topic":"Artificial Intelligence"})
